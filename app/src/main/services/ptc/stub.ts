/** Bump on ANY change to the generated stub text â€” the stub is prompt-adjacent surface
...
// argus_tools â€” generated. Call Argus tools from this script; only stdout returns to the model.
...
// No request ids on the wire â€” serialize every round-trip so concurrent callers
