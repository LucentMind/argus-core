export const IPC = {
  ...
  autonomyPromote: 'autonomy:promote',
  autonomyDemote: 'autonomy:demote',
  autonomyAck: 'autonomy:ack',
  autonomyReportGenerate: 'autonomy:report-generate',
  autonomyReportPost: 'autonomy:report-post',
  autonomyChanged: 'autonomy:changed',
